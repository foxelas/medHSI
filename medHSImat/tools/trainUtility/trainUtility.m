...
%
% For details check https://foxelas.github.io/medHSIdocs/classtrain_utility.html
% ======================================================================
classdef trainUtility
    ...
    methods (Static)
        ...
        function [SVMModel] = SVM(Xtrain, ytrain, svmSettings)
            ...
            disabledParents = initUtility.FunctionsWithoutSVMOptimization();
            hasOptimization = ~commonUtility.IsChild(disabledParents);
